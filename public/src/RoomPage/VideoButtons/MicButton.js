...
const MicButton = ({ stream }) => {
  ...
  return (
    <IconWithTextButton svgPaths={micSvg} enabled={!isMicMuted} onClick={handelmicButtonPressed} viewBox={"0 0 262.73 379.6"} />
  )
}
